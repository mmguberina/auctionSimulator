...
auctions_per_strategy_update = 1000
max_epochs = 1
epoch = 0
...
if __name__ == "__main__":
    ...
    for agent_num in range(n_agents):
        agents.append(Agent("all_the_same", max_epochs, auctions_per_strategy_update))
...
#    SavingAgents(agents, SW_history, payment_method, max_epochs, auctions_per_strategy_update, epochs_run)
#    results, results_SW = pandas_results(n_agents, payment_methods, max_epochs, auctions_per_strategy_update, whole_epochs_runs)
    #plotAgentsChanges2D_all(results,plot_saving_switch)
        ...
        #plotSW(SW_history, auctions_per_strategy_update, payment_method, epochs_run)
        #plotPayoffs(agents, payment_method, auctions_per_strategy_update, epochs_run)
